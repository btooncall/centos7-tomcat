...
ADD jars/logstash-gelf-1.9.0.jar /opt/tomcat/lib/logstash-gelf-1.9.0.jar
...
ADD jars/json-simple-1.1.1.jar /opt/tomcat/lib/json-simple-1.1.1.jar
...
ADD jars/jedis-2.8.0.jar /opt/tomcat/lib/jedis-2.8.0.jar
...
ADD jars/commons-pool2-2.4.2.jar /opt/tomcat/lib/commons-pool2-2.4.2.jar
